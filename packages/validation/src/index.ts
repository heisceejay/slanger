...
import {
  validateInventory, validateOrthography, validatePhonologyConfig, validateWordForm
} from "@slanger/phonology";
import {
  validateMorphologyConfig, generateParadigmTable, validateParadigmPhonology
} from "@slanger/morphology";
import { validateSyntaxConfig } from "@slanger/syntax";
